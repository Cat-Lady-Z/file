...
public class OrderExcelTitle {
    ...
    public static final String titleString2 = "平台订单号,商户订单号,运单号,订单类型,商户,公司,发货门店,创建日期,配送渠道,订单当前状态,配送价格,基础价,距离加价,时间加价,重量加价,配送距离,订单来源,省份,城市,县区,门店地址,发件人电话,顾客名称,顾客地址,顾客电话,骑手姓名,骑手电话,货品名称,备注,门店发单,骑手接单,骑手取货,完成,已取消,系统异常";
